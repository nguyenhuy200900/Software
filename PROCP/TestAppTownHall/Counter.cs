...
namespace TestAppTownHall
{
   public enum CounterType
    {
        GENERAL, TAXandROOMRENTAL, DRIVERLICENSEandPASSPORTID
    }
   public class Counter
    {
        ...
        public void PaintCounter(Graphics gr)
        {
            ...
            if (this.counterType == CounterType.GENERAL)
            {
                brush = new SolidBrush(Color.FromArgb(0, 204, 255));
            }
            else if (this.counterType == CounterType.TAXandROOMRENTAL)
            {
